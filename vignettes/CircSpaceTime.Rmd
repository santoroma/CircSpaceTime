...
```{r label0"stirm1$Dmr$, message=FALSE, echo=TRUE, warning=FALSE , eval = TRUE}
...
```{r label="storm2", message=FALSE, echo=TRUE, warning=FALSE, eval = TRUE}
...
```{r label="storm_fit_load", message=FALSE, warning=FALSE, include=FALSE}
    data(storm)
```
...
```{r label="calm_fit_load", message=FALSE, warning=FALSE, include=FALSE}
  rm(list = ls())
...
```{r label="calmacheck1", message=FALSE, echo=TRUE, warning=FALSE, eval=TRUE}
check <- ConvCheck(mod)
 check$Rhat
```
