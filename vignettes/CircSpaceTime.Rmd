...
```{r label="print_check1", message=FALSE, echo=FALSE, warning=FALSE, cache=FALSE, }
check.storm$Rhat
```
...
check.calm <- ConvCheck(mod)
 check.calm$Rhat
```

```{r label="print.calmacheck1", message=FALSE, echo=FALSE, warning=FALSE, eval=FALSE}
check.calm <- ConvCheck(mod)
 check.calm$Rhat
```
